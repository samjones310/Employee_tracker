...
$lat= $firebase->get(DEFAULT_PATH.'/employees_location'.'/uMN72Gk47xYWQZZWgWoYuo1dNxZ2'.'/customer_lat');
$lng= $firebase->get(DEFAULT_PATH.'/employees_location'.'/uMN72Gk47xYWQZZWgWoYuo1dNxZ2'.'/customer_lng');
$lat1= $firebase->get(DEFAULT_PATH.'/employees_location'.'/uMN72Gk47xYWQZZWgWoYuo1dNxZ2'.'/lat');
$lng1= $firebase->get(DEFAULT_PATH.'/employees_location'.'/uMN72Gk47xYWQZZWgWoYuo1dNxZ2'.'/lng');
$lat=10.9675;
$lng=76.9182;
?>
<head>
