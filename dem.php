...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-2" style="overflow:scroll;height:500px">
			<form action="dem.php" method="post"><div class="list"><a href="dem.php"><img src="pp.jpg" id="im"> &nbsp <input type="submit" class="btn btn-primary" name="E741" value="Aswin"> <img src="<?php echo $x1[0]; ?>.png" height="40px" width="40px"></a></div></form><hr/>
			<form action="dem.php" method="post"><div class="list"><a href="dem.php"><img src="pp.jpg" id="im"> &nbsp <input type="submit" class="btn btn-primary" name="E941" value="David"> <img src="<?php echo $x1[1]; ?>.png" height="40px" width="40px"></a></div></form><hr/>
		...
		<div class="col-md-10 map">
			<iframe src="dem1.php" height="500px" width="100%"></iframe>
		</div>
	</div>
</div>
