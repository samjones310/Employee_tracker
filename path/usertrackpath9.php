...
$lat= $firebase->get(DEFAULT_PATH.'/employees_location'.'/M8glulyV99Y2aJJr8R6Sw9mIQOD2'.'/customer_lat');
$lng= $firebase->get(DEFAULT_PATH.'/employees_location'.'/M8glulyV99Y2aJJr8R6Sw9mIQOD2'.'/customer_lng');
$lat1= $firebase->get(DEFAULT_PATH.'/employees_location'.'/M8glulyV99Y2aJJr8R6Sw9mIQOD2'.'/lat');
$lng1= $firebase->get(DEFAULT_PATH.'/employees_location'.'/M8glulyV99Y2aJJr8R6Sw9mIQOD2'.'/lng');
?>
<head>
  <meta charset="UTF-8">
